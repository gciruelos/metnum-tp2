...
\abstracto{En el presente trabajo nos proponemos a modelar y estudiar una serie de métodos para la creación de rankings. Estos serán estudiados en dos contextos. Primero, como pilar fundamental de los motores de busqueda, allí explicaremos PageRank, su base teórica, los detalles de su implementación y optimizaciones necesarias, seguido por un análisis sobre su funcionamiento bajo distintos criterios. Luego, aplicaremos GeM, una adaptación de PageRank a ligas deportivas, para calcular el puntaje de los equipos de fútbol argentino de primera división y contrastarlos con el método utilizado actualmente para decidir las posiciones en el torneo.}
